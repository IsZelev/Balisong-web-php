...
<head>
        ...
        <title> <?php echo "Balisong tricks" ?> </title>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function validateForm() {
                ...
                if (!email) {
                    errorDiv.textContent = "Inserire l'indirizzo email.";
                    return false; // nessuna POST
                } else if (!email.includes('@')) {
                    errorDiv.textContent = "Indirizzo email non valido.";
                    return false; // nessuna POST
                }
                return "index.php"; // POST verso il server alla stessa pagina PHP
            }
...
<body onload="searchTrick()">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto">
                        <form method="POST" action="" class="d-flex">
                            ...
                            <button class="btn btn-outline-light" type="submit" id="searchBtn" onclick="searchTrick()">Cerca</button>
                        </form>
        ...
        <div class="text text-center" id = "trickTitle"></div>
        <div class="container">
            <div class="row">
